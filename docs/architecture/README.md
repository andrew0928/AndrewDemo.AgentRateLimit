...
新的 implementation decision 應先回到 `harness-design.md` 檢查是否仍符合穩定 contract。若是永久性取捨，請在 `docs/decisions/` 補 decision record；若是行為要求，請在 `spec/testcases/` 補 Given/When/Then。
